...
CKEDITOR.dialog.add( 'markdowndialog', function( editor ) {
  ...
  return {
    ...
    onShow: function() {
      this.setValueOf( 'main', 'data', oldData = window.toMarkdown(editor.getData()) );
    },
    ...
    onOk: (function() {
      ...
      return function( event ) {
        ...
        var newData = window.marked(this.getValueOf( 'main', 'data' ).replace( /\r/g, '' ));
